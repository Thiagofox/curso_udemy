...
class Mock {
    ...
    fun getPhrase(value: Int): String {
        ...
        if (value == all) {
           return myListPhrase[Random.nextInt(myListPhrase.size)].description
        }
        val filteredList = myListPhrase.filter { it.categoryId == value }
        // poderia ser feito da seguinte forma na linha debaixo
        // val filteredList = myListPhrase.filter { it.categoryId == value || value == all }
