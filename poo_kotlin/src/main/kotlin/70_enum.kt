...
// Enum -> Vem de Enumerador
// Tem como objetivo limitar o intervalo de valores
...
fun main() {
    for (index in Prioridade.values()){
//        if(index == Prioridade.Media)
        println(index)
    }
}
